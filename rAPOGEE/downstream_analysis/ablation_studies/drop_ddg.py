...
X = pd.read_csv("../../checkpoints/mithril_features.csv", sep="\t", index_col=0).drop("ddG", axis=1)
...
pk.dump((cv_ground_truth, cv_predictions), open("./ablation_cv/cv_predictions_no_ddG.pk", "wb"))