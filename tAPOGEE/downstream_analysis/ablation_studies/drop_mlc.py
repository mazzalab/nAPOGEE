...
mlc_features = ['MLC_score', 'OEUF_score']
...
X = pd.read_csv("../../checkpoints/mithril_features.csv", sep="\t", index_col=0).drop(columns=mlc_features)
...
pk.dump(tuned_model_svc, open("./partial_models/model_svc_no_mlc.pk", "wb"))
