...
structural_features = ['ss_distorsion', 'ddG', 'bulge', 'stem', 'hairpin', 'loop', 'unpaired_frequency']
...
X = pd.read_csv("../../checkpoints/mithril_features.csv", sep="\t", index_col=0).drop(columns=structural_features)
...
pk.dump(tuned_model_svc, open("./partial_models/model_svc_no_structure.pk", "wb"))
