...
conservation_features = [
    'PhastCons_100V', 'PhyloP_100V', 'ref_frequency', 'alt_frequency', 'coverage',
    'entropy', 'conservation_blocks', 'PWM_score', 'unpaired_frequency'
]
...
X = pd.read_csv("../../checkpoints/mithril_features.csv", sep="\t", index_col=0).drop(columns=conservation_features)
...
pk.dump(tuned_model_svc, open("./partial_models/model_svc_no_conservation.pk", "wb"))
