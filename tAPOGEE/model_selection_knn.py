...
tuned_model_knn = GridSearchCV(
    estimator=model_knn, param_grid=preprocess_grid,
...
tuned_model_knn.fit(X_extended, y)
pk.dump(tuned_model_knn, open("checkpoints/candidate_models/model_knn.pk", "wb"))

print("################## END ##################")
print("OOB gridsearch params:")
print(tuned_model_knn.best_estimator_[-1].best_params, tuned_model_knn.best_estimator_[-1].best_score)
print("CV gridsearch params:")
print(tuned_model_knn.best_params_, tuned_model_knn.best_score_)
